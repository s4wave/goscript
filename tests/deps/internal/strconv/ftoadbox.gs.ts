...
export function dboxFtoa64(d: __goscript_ftoa.decimalSlice | $.VarRef<__goscript_ftoa.decimalSlice> | null, mant: bigint, exp: number, denorm: boolean): void {
	...
	let [zi, exact] = dboxMulPow64($.uint64Shl($.uint64($.uint64Add(($.uint64Mul(mant, 2n)), 1n)), _u3b2), $.markAsStructValue($.cloneStructValue(_u3c6)))
	...
	if ($.uint(r, 32) < $.uint(_u3b4i, 32)) {
		...
		if ($.uint(r, 32) == $.uint(_u3b4i, 32)) {
			let [parity, __goscriptShadow4] = dboxParity64($.uint64($.uint64Sub(($.uint64Mul(mant, 2n)), 1n)), $.markAsStructValue($.cloneStructValue(_u3c6)), _u3b2)
	...
	let yru = $.uint64Add(($.uint64Mul(10n, s)), $.uint64(t))
	if ($.uint(_u3c1, 32) == $.uint(0, 32)) {
		let [parity, __goscriptShadow7] = dboxParity64($.uint64Mul(mant, 2n), $.markAsStructValue($.cloneStructValue(_u3c6)), _u3b2)
...
export function umul128Upper64(x: bigint, y: bigint): bigint {
	let a = $.uint($.uint($.uint64Shr(x, 32n), 32), 32)
	let b = $.uint($.uint(x, 32), 32)
	let c = $.uint($.uint($.uint64Shr(y, 32n), 32), 32)
	...
	let intermediate = $.uint64Add(($.uint64Add(($.uint64Shr(bd, 32n)), $.uint64($.uint(ad, 32)))), $.uint64($.uint(bc, 32)))

	return $.uint64Add(($.uint64Add(($.uint64Add(ac, ($.uint64Shr(intermediate, 32n)))), ($.uint64Shr(ad, 32n)))), ($.uint64Shr(bc, 32n)))
}
...
export function dboxMulPow32(u: number, phi: bigint): [number, boolean] {
	...
	intPart = $.uint($.uint($.uint64Shr(r, 32n), 32), 32)
...
export function dboxParity64(mant2: bigint, phi: __goscript_math.uint128, beta: number): [boolean, boolean] {
	...
	parity = ($.uint64And(($.uint64Shr(r.Hi, (64 - beta))), 1n)) != 0n
...
export function dboxParity32(mant2: number, phi: bigint, beta: number): [boolean, boolean] {
	...
	parity = ($.uint64And(($.uint64Shr(r, (64 - beta))), 1n)) != 0n
...
export function dboxRange64(_u3c6: __goscript_math.uint128, _u3b2: number): [bigint, bigint] {
	let left: bigint = 0n
	let right: bigint = 0n
	left = $.uint64Shr(($.uint64Sub(_u3c6.Hi, ($.uint64Shr(_u3c6.Hi, 54n)))), (((64 - 52) - 1) - _u3b2))
	right = $.uint64Shr(($.uint64Add(_u3c6.Hi, ($.uint64Shr(_u3c6.Hi, 53n)))), (((64 - 52) - 1) - _u3b2))
	return [left, right]
}
...
export function dboxRange32(_u3c6: bigint, _u3b2: number): [number, number] {
	let left: number = 0
	let right: number = 0
	left = $.uint($.uint($.uint64Shr(($.uint64Sub(_u3c6, ($.uint64Shr(_u3c6, 25n)))), (((64 - 23) - 1) - _u3b2)), 32), 32)
	right = $.uint($.uint($.uint64Shr(($.uint64Add(_u3c6, ($.uint64Shr(_u3c6, 24n)))), (((64 - 23) - 1) - _u3b2)), 32), 32)
	return [$.uint(left, 32), $.uint(right, 32)]
}

export function dboxRoundUp64(phi: __goscript_math.uint128, beta: number): bigint {
	return $.uint64Div(($.uint64Add(($.uint64Shr(phi.Hi, ((((Math.trunc(128 / 2)) - 52) - 2) - beta))), 1n)), 2n)
}

export function dboxRoundUp32(phi: bigint, beta: number): number {
	return $.uint(Math.trunc($.uint($.uint64Add(($.uint64Shr(phi, (((64 - 23) - 2) - beta))), 1n), 32) / 2), 32)
}
