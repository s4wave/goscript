...
export class mapFileInfo {
	...
	public Info(): [fs.FileInfo | null, $.GoError] {
		...
		return [$.interfaceValue<fs.FileInfo | null>(i, "*fstest.mapFileInfo", { kind: $.TypeKind.Pointer, elemType: "fstest.mapFileInfo" }), null]
	}
	...
	public String(): string {
		const i: mapFileInfo | $.VarRef<mapFileInfo> | null = this
		return fs.FormatFileInfo($.pointerValueOrNil($.interfaceValue<fs.FileInfo | null>(i, "*fstest.mapFileInfo", { kind: $.TypeKind.Pointer, elemType: "fstest.mapFileInfo" }))!)
	}
...
export class openMapFile {
	...
	public Read(b: $.Slice<number>): [number, $.GoError] {
		...
		if ($.pointerValue<openMapFile>(f).offset < 0n) {
			return [0, $.interfaceValue<$.GoError>(new fs.PathError({Op: "read", Path: $.pointerValue<openMapFile>(f).path, Err: fs.ErrInvalid}), "*fs.PathError", { kind: $.TypeKind.Pointer, elemType: "fs.PathError" })]
		}
	...
	public Seek(offset: bigint, whence: number): [bigint, $.GoError] {
		...
		if ((offset < 0n) || (offset > $.int64($.len($.pointerValue<MapFile>($.pointerValue<openMapFile>(f).mapFileInfo.f).Data)))) {
			return [0n, $.interfaceValue<$.GoError>(new fs.PathError({Op: "seek", Path: $.pointerValue<openMapFile>(f).path, Err: fs.ErrInvalid}), "*fs.PathError", { kind: $.TypeKind.Pointer, elemType: "fs.PathError" })]
		}
	...
	public Stat(): [fs.FileInfo | null, $.GoError] {
		const f: openMapFile | $.VarRef<openMapFile> | null = this
		return [$.interfaceValue<fs.FileInfo | null>($.pointerValue<openMapFile>(f)._fields.mapFileInfo, "*fstest.mapFileInfo", { kind: $.TypeKind.Pointer, elemType: "fstest.mapFileInfo" }), null]
	}
...
export class mapDir {
	...
	public Read(b: $.Slice<number>): [number, $.GoError] {
		const d: mapDir | $.VarRef<mapDir> | null = this
		return [0, $.interfaceValue<$.GoError>(new fs.PathError({Op: "read", Path: $.pointerValue<mapDir>(d).path, Err: fs.ErrInvalid}), "*fs.PathError", { kind: $.TypeKind.Pointer, elemType: "fs.PathError" })]
	}
	...
	public ReadDir(count: number): [$.Slice<fs.DirEntry | null>, $.GoError] {
		...
		for (let __goscriptRangeTarget1 = list, i = 0; i < $.len(__goscriptRangeTarget1); i++) {
			list![i] = $.interfaceValue<fs.DirEntry | null>($.indexRef($.pointerValue<mapDir>(d).entry!, $.pointerValue<mapDir>(d).offset + i), "*fstest.mapFileInfo", { kind: $.TypeKind.Pointer, elemType: "fstest.mapFileInfo" })
		}
	...
	public Stat(): [fs.FileInfo | null, $.GoError] {
		const d: mapDir | $.VarRef<mapDir> | null = this
		return [$.interfaceValue<fs.FileInfo | null>($.pointerValue<mapDir>(d)._fields.mapFileInfo, "*fstest.mapFileInfo", { kind: $.TypeKind.Pointer, elemType: "fstest.mapFileInfo" }), null]
	}
...
export async function MapFS_Open(fsys: MapFS, name: string): globalThis.Promise<[fs.File | null, $.GoError]> {
	...
	if ((file != null) && ($.uint(($.pointerValue<MapFile>(file).Mode & fs.ModeDir), 32) == $.uint(0, 32))) {
		// Ordinary file
		return [$.interfaceValue<fs.File | null>(new openMapFile({path: name, mapFileInfo: (() => { const __goscriptLiteralField0 = path2.Base(name); return $.markAsStructValue(new mapFileInfo({name: __goscriptLiteralField0, f: file})) })(), offset: 0n}), "*fstest.openMapFile", { kind: $.TypeKind.Pointer, elemType: "fstest.openMapFile" }), null]
	}
	...
	return [$.interfaceValue<fs.File | null>(new mapDir({path: name, mapFileInfo: $.markAsStructValue(new mapFileInfo({name: elem, f: file})), entry: list, offset: 0}), "*fstest.mapDir", { kind: $.TypeKind.Pointer, elemType: "fstest.mapDir" }), null]
}
...
export function MapFS_ReadLink(fsys: MapFS, name: string): [string, $.GoError] {
	...
	if (err != null) {
		return ["", $.interfaceValue<$.GoError>(new fs.PathError({Op: "readlink", Path: name, Err: err}), "*fs.PathError", { kind: $.TypeKind.Pointer, elemType: "fs.PathError" })]
	}
	if ($.uint(fs.FileMode_Type($.pointerValue<MapFile>($.pointerValue<mapFileInfo>(info).f).Mode), 32) != $.uint(fs.ModeSymlink, 32)) {
		return ["", $.interfaceValue<$.GoError>(new fs.PathError({Op: "readlink", Path: name, Err: fs.ErrInvalid}), "*fs.PathError", { kind: $.TypeKind.Pointer, elemType: "fs.PathError" })]
	}
...
export function MapFS_Lstat(fsys: MapFS, name: string): [fs.FileInfo | null, $.GoError] {
	...
	if (err != null) {
		return [null, $.interfaceValue<$.GoError>(new fs.PathError({Op: "lstat", Path: name, Err: err}), "*fs.PathError", { kind: $.TypeKind.Pointer, elemType: "fs.PathError" })]
	}
	return [$.interfaceValue<fs.FileInfo | null>(info, "*fstest.mapFileInfo", { kind: $.TypeKind.Pointer, elemType: "fstest.mapFileInfo" }), null]
}
...
export function MapFS_ReadFile(fsys: MapFS, name: string): [$.Slice<number>, $.GoError] {
	return fs.ReadFile($.interfaceValue<fs.FS | null>($.markAsStructValue(new fsOnly({FS: $.namedValueInterfaceValue<fs.FS | null>(fsys, "fstest.MapFS", {Glob: (receiver: any, ...args: any[]) => (MapFS_Glob as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), Lstat: (receiver: any, ...args: any[]) => (MapFS_Lstat as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), Open: (receiver: any, ...args: any[]) => (MapFS_Open as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), ReadDir: (receiver: any, ...args: any[]) => (MapFS_ReadDir as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), ReadFile: (receiver: any, ...args: any[]) => (MapFS_ReadFile as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), ReadLink: (receiver: any, ...args: any[]) => (MapFS_ReadLink as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), Stat: (receiver: any, ...args: any[]) => (MapFS_Stat as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), Sub: (receiver: any, ...args: any[]) => (MapFS_Sub as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), lstat: (receiver: any, ...args: any[]) => (MapFS_lstat as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), resolveSymlinks: (receiver: any, ...args: any[]) => (MapFS_resolveSymlinks as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args))}, "fstest.MapFS", [{ name: "Glob", args: [{ name: "pattern", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "string" } } }, { name: "_r1", type: "error" }] }, { name: "Lstat", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: "fs.FileInfo" }, { name: "_r1", type: "error" }] }, { name: "Open", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: "fs.File" }, { name: "_r1", type: "error" }] }, { name: "ReadDir", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: "fs.DirEntry" } }, { name: "_r1", type: "error" }] }, { name: "ReadFile", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "ReadLink", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "_r1", type: "error" }] }, { name: "Stat", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: "fs.FileInfo" }, { name: "_r1", type: "error" }] }, { name: "Sub", args: [{ name: "dir", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: "fs.FS" }, { name: "_r1", type: "error" }] }, { name: "lstat", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "fstest.mapFileInfo" } }, { name: "_r1", type: "error" }] }, { name: "resolveSymlinks", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "ok", type: { kind: $.TypeKind.Basic, name: "bool" } }] }])})), "fstest.fsOnly", "fstest.fsOnly"), name)
}
...
export async function MapFS_Glob(fsys: MapFS, pattern: string): globalThis.Promise<[$.Slice<string>, $.GoError]> {
	return fs.Glob($.interfaceValue<fs.FS | null>($.markAsStructValue(new fsOnly({FS: $.namedValueInterfaceValue<fs.FS | null>(fsys, "fstest.MapFS", {Glob: (receiver: any, ...args: any[]) => (MapFS_Glob as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), Lstat: (receiver: any, ...args: any[]) => (MapFS_Lstat as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), Open: (receiver: any, ...args: any[]) => (MapFS_Open as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), ReadDir: (receiver: any, ...args: any[]) => (MapFS_ReadDir as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), ReadFile: (receiver: any, ...args: any[]) => (MapFS_ReadFile as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), ReadLink: (receiver: any, ...args: any[]) => (MapFS_ReadLink as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), Stat: (receiver: any, ...args: any[]) => (MapFS_Stat as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), Sub: (receiver: any, ...args: any[]) => (MapFS_Sub as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), lstat: (receiver: any, ...args: any[]) => (MapFS_lstat as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), resolveSymlinks: (receiver: any, ...args: any[]) => (MapFS_resolveSymlinks as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args))}, "fstest.MapFS", [{ name: "Glob", args: [{ name: "pattern", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "string" } } }, { name: "_r1", type: "error" }] }, { name: "Lstat", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: "fs.FileInfo" }, { name: "_r1", type: "error" }] }, { name: "Open", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: "fs.File" }, { name: "_r1", type: "error" }] }, { name: "ReadDir", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: "fs.DirEntry" } }, { name: "_r1", type: "error" }] }, { name: "ReadFile", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "ReadLink", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "_r1", type: "error" }] }, { name: "Stat", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: "fs.FileInfo" }, { name: "_r1", type: "error" }] }, { name: "Sub", args: [{ name: "dir", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: "fs.FS" }, { name: "_r1", type: "error" }] }, { name: "lstat", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "fstest.mapFileInfo" } }, { name: "_r1", type: "error" }] }, { name: "resolveSymlinks", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "ok", type: { kind: $.TypeKind.Basic, name: "bool" } }] }])})), "fstest.fsOnly", "fstest.fsOnly"), pattern)
}

export async function MapFS_Sub(fsys: MapFS, dir: string): globalThis.Promise<[fs.FS | null, $.GoError]> {
	return fs.Sub($.interfaceValue<fs.FS | null>($.markAsStructValue(new noSub({MapFS: fsys})), "fstest.noSub", "fstest.noSub"), dir)
}
