...
export class Zipf {
	...
	static __typeInfo = $.registerStructType(
		...
		Zipf,
		[{ name: "r", key: "r", type: { kind: $.TypeKind.Pointer, elemType: "rand.Rand" }, pkgPath: "math/rand", index: [0], offset: 0, exported: false }, { name: "imax", key: "imax", type: { kind: $.TypeKind.Basic, name: "float64" }, pkgPath: "math/rand", index: [1], offset: 8, exported: false }, { name: "v", key: "v", type: { kind: $.TypeKind.Basic, name: "float64" }, pkgPath: "math/rand", index: [2], offset: 16, exported: false }, { name: "q", key: "q", type: { kind: $.TypeKind.Basic, name: "float64" }, pkgPath: "math/rand", index: [3], offset: 24, exported: false }, { name: "s", key: "s", type: { kind: $.TypeKind.Basic, name: "float64" }, pkgPath: "math/rand", index: [4], offset: 32, exported: false }, { name: "oneminusQ", key: "oneminusQ", type: { kind: $.TypeKind.Basic, name: "float64" }, pkgPath: "math/rand", index: [5], offset: 40, exported: false }, { name: "oneminusQinv", key: "oneminusQinv", type: { kind: $.TypeKind.Basic, name: "float64" }, pkgPath: "math/rand", index: [6], offset: 48, exported: false }, { name: "hxm", key: "hxm", type: { kind: $.TypeKind.Basic, name: "float64" }, pkgPath: "math/rand", index: [7], offset: 56, exported: false }, { name: "hx0minusHxm", key: "hx0minusHxm", type: { kind: $.TypeKind.Basic, name: "float64" }, pkgPath: "math/rand", index: [8], offset: 64, exported: false }]
	)
}
