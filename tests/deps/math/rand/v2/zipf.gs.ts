...
export class Zipf {
	...
	static __typeInfo = $.registerStructType(
		"rand.Zipf",
		() => new Zipf(),
		[{ name: "Uint64", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "uint64" } }] }, { name: "h", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Basic, name: "float64" } }] }, { name: "hinv", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Basic, name: "float64" } }] }],
		Zipf,
		[{ name: "r", key: "r", type: { kind: $.TypeKind.Pointer, elemType: "rand.Rand" } }, { name: "imax", key: "imax", type: { kind: $.TypeKind.Basic, name: "float64" } }, { name: "v", key: "v", type: { kind: $.TypeKind.Basic, name: "float64" } }, { name: "q", key: "q", type: { kind: $.TypeKind.Basic, name: "float64" } }, { name: "s", key: "s", type: { kind: $.TypeKind.Basic, name: "float64" } }, { name: "oneminusQ", key: "oneminusQ", type: { kind: $.TypeKind.Basic, name: "float64" } }, { name: "oneminusQinv", key: "oneminusQinv", type: { kind: $.TypeKind.Basic, name: "float64" } }, { name: "hxm", key: "hxm", type: { kind: $.TypeKind.Basic, name: "float64" } }, { name: "hx0minusHxm", key: "hx0minusHxm", type: { kind: $.TypeKind.Basic, name: "float64" } }]
	)
}
