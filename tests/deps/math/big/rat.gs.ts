...
export class Rat {
	...
	public async SetString(s: string): globalThis.Promise<[Rat | $.VarRef<Rat> | null, boolean]> {
...

		{
			...
			if (sep >= 0) {
				...
				let err: $.GoError = null as $.GoError
				{
					let __goscriptTuple8: any = await __goscript_natconv.nat_scan($.pointerValue<Rat>(z).b.abs, $.interfaceValue<io.ByteScanner | null>(r, "*strings.Reader"), 0, false)
		...
		// exponent
		let [neg, err] = await __goscript_intconv.scanSign($.interfaceValue<io.ByteScanner | null>(r, "*strings.Reader"))
		if (err != null) {
			return [null, false]
		}
		...
		let base: number = 0
		let fcount: number = 0
		let __goscriptTuple10: any = await __goscript_natconv.nat_scan($.pointerValue<Rat>(z).a.abs, $.interfaceValue<io.ByteScanner | null>(r, "*strings.Reader"), 0, true)
		...
		let exp: bigint = 0n
		let ebase: number = 0
		let __goscriptTuple11: any = await __goscript_ratconv.scanExponent($.interfaceValue<io.ByteScanner | null>(r, "*strings.Reader"), true, true)
	...
	public async UnmarshalText(text: $.Slice<number>): globalThis.Promise<$.GoError> {
...

		{
			...
			if (!ok) {
				return fmt.Errorf("math/big: cannot unmarshal %q into a *big.Rat", $.interfaceValue<any>(text, "[]byte"))
			}
		}
		return null
	}
	...
	static __typeInfo = $.registerStructType(
		"big.Rat",
		() => new Rat(),
		[{ name: "Abs", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "Add", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "AppendText", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { type: "error" }] }, { name: "Cmp", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "Denom", args: [], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Int" } }] }, { name: "Float32", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "float32" } }, { type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "Float64", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "float64" } }, { type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "FloatPrec", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "int" } }, { type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "FloatString", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Basic, name: "string" } }] }, { name: "GobDecode", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: "error" }] }, { name: "GobEncode", args: [], returns: [{ type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { type: "error" }] }, { name: "Inv", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "IsInt", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "MarshalText", args: [], returns: [{ type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { type: "error" }] }, { name: "Mul", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "Neg", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "Num", args: [], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Int" } }] }, { name: "Quo", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "RatString", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "string" } }] }, { name: "Scan", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: "error" }] }, { name: "Set", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "SetFloat64", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "SetFrac", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "SetFrac64", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "SetInt", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "SetInt64", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "SetString", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }, { type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "SetUint64", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "Sign", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "String", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "string" } }] }, { name: "Sub", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }, { name: "UnmarshalText", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: "error" }] }, { name: "marshal", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "norm", args: [], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }] }],
		Rat,
		[{ name: "a", key: "a", type: "big.Int" }, { name: "b", key: "b", type: "big.Int" }]
	)
}
