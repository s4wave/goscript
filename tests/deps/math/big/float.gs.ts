...
export class Float {
	...
	public async Add(x: Float | $.VarRef<Float> | null, y: Float | $.VarRef<Float> | null): globalThis.Promise<Float | $.VarRef<Float> | null> {
		...
		if ((($.uint($.pointerValue<Float>(x).form, 8) == $.uint(2, 8)) && ($.uint($.pointerValue<Float>(y).form, 8) == $.uint(2, 8))) && ($.pointerValue<Float>(x).neg != $.pointerValue<Float>(y).neg)) {
			...
			$.pointerValue<Float>(z).neg = false
			$.panic($.interfaceValue<any>($.markAsStructValue(new ErrNaN({msg: "addition of infinities with opposite signs"})), "big.ErrNaN"))
		}
	...
	public async Mul(x: Float | $.VarRef<Float> | null, y: Float | $.VarRef<Float> | null): globalThis.Promise<Float | $.VarRef<Float> | null> {
		...
		if ((($.uint($.pointerValue<Float>(x).form, 8) == $.uint(0, 8)) && ($.uint($.pointerValue<Float>(y).form, 8) == $.uint(2, 8))) || (($.uint($.pointerValue<Float>(x).form, 8) == $.uint(2, 8)) && ($.uint($.pointerValue<Float>(y).form, 8) == $.uint(0, 8)))) {
			...
			$.pointerValue<Float>(z).form = $.uint(0, 8)
			$.pointerValue<Float>(z).neg = false
			$.panic($.interfaceValue<any>($.markAsStructValue(new ErrNaN({msg: "multiplication of zero with infinity"})), "big.ErrNaN"))
		}
	...
	public async Parse(s: string, base: number): globalThis.Promise<[Float | $.VarRef<Float> | null, number, $.GoError]> {
		...
		{
			let __goscriptTuple0: any = await Float.prototype.scan.call(z, $.interfaceValue<io.ByteScanner | null>(r, "*strings.Reader"), base)
	...
	public async Quo(x: Float | $.VarRef<Float> | null, y: Float | $.VarRef<Float> | null): globalThis.Promise<Float | $.VarRef<Float> | null> {
		...
		if ((($.uint($.pointerValue<Float>(x).form, 8) == $.uint(0, 8)) && ($.uint($.pointerValue<Float>(y).form, 8) == $.uint(0, 8))) || (($.uint($.pointerValue<Float>(x).form, 8) == $.uint(2, 8)) && ($.uint($.pointerValue<Float>(y).form, 8) == $.uint(2, 8)))) {
			...
			$.pointerValue<Float>(z).form = $.uint(0, 8)
			$.pointerValue<Float>(z).neg = false
			$.panic($.interfaceValue<any>($.markAsStructValue(new ErrNaN({msg: "division of zero by zero or infinity by infinity"})), "big.ErrNaN"))
		}
	...
	public async Scan(s: fmt2.ScanState | null, ch: number): globalThis.Promise<$.GoError> {
		...
		let [, , err] = await Float.prototype.scan.call(z, $.interfaceValue<io.ByteScanner | null>($.markAsStructValue(new __goscript_intconv.byteReader({ScanState: s})), "big.byteReader"), 0)
		return err
	}
	...
	public async SetFloat64(x: number): globalThis.Promise<Float | $.VarRef<Float> | null> {
		...
		if (math.IsNaN(x)) {
			$.panic($.interfaceValue<any>($.markAsStructValue(new ErrNaN({msg: "Float.SetFloat64(NaN)"})), "big.ErrNaN"))
		}
		$.pointerValue<Float>(z).acc = $.int(0, 8)
	...
	public async Sqrt(x: Float | $.VarRef<Float> | null): globalThis.Promise<Float | $.VarRef<Float> | null> {
		...
		if (await Float.prototype.Sign.call(x) == -1) {
			...
			$.panic($.interfaceValue<any>($.markAsStructValue(new ErrNaN({msg: "square root of negative operand"})), "big.ErrNaN"))
		}
	...
	public async Sub(x: Float | $.VarRef<Float> | null, y: Float | $.VarRef<Float> | null): globalThis.Promise<Float | $.VarRef<Float> | null> {
		...
		if ((($.uint($.pointerValue<Float>(x).form, 8) == $.uint(2, 8)) && ($.uint($.pointerValue<Float>(y).form, 8) == $.uint(2, 8))) && ($.pointerValue<Float>(x).neg == $.pointerValue<Float>(y).neg)) {
			...
			$.pointerValue<Float>(z).form = $.uint(0, 8)
			$.pointerValue<Float>(z).neg = false
			$.panic($.interfaceValue<any>($.markAsStructValue(new ErrNaN({msg: "subtraction of infinities with equal signs"})), "big.ErrNaN"))
		}
	...
	public async UnmarshalText(text: $.Slice<number>): globalThis.Promise<$.GoError> {
		...
		if (err != null) {
			err = fmt2.Errorf("math/big: cannot unmarshal %q into a *big.Float (%v)", $.interfaceValue<any>(text, "[]byte"), (err as any))
		}
		return err
	}
	...
	static __typeInfo = $.registerStructType(
		"big.Float",
		() => new Float(),
		[{ name: "Abs", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "Acc", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "int8", typeName: "big.Accuracy" } }] }, { name: "Add", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "Append", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "AppendText", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { type: "error" }] }, { name: "Cmp", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "Copy", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "Float32", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "float32" } }, { type: { kind: $.TypeKind.Basic, name: "int8", typeName: "big.Accuracy" } }] }, { name: "Float64", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "float64" } }, { type: { kind: $.TypeKind.Basic, name: "int8", typeName: "big.Accuracy" } }] }, { name: "Format", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [] }, { name: "GobDecode", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: "error" }] }, { name: "GobEncode", args: [], returns: [{ type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { type: "error" }] }, { name: "Int", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Int" } }, { type: { kind: $.TypeKind.Basic, name: "int8", typeName: "big.Accuracy" } }] }, { name: "Int64", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "int64" } }, { type: { kind: $.TypeKind.Basic, name: "int8", typeName: "big.Accuracy" } }] }, { name: "IsInf", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "IsInt", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "MantExp", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "MarshalText", args: [], returns: [{ type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { type: "error" }] }, { name: "MinPrec", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "uint" } }] }, { name: "Mode", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "uint8", typeName: "big.RoundingMode" } }] }, { name: "Mul", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "Neg", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "Parse", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }, { type: { kind: $.TypeKind.Basic, name: "int" } }, { type: "error" }] }, { name: "Prec", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "uint" } }] }, { name: "Quo", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "Rat", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Rat" } }, { type: { kind: $.TypeKind.Basic, name: "int8", typeName: "big.Accuracy" } }] }, { name: "Scan", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: "error" }] }, { name: "Set", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "SetFloat64", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "SetInf", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "SetInt", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "SetInt64", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "SetMantExp", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "SetMode", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "SetPrec", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "SetRat", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "SetString", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }, { type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "SetUint64", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "Sign", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "Signbit", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "Sqrt", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "String", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "string" } }] }, { name: "Sub", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "Text", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Basic, name: "string" } }] }, { name: "Uint64", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "uint64" } }, { type: { kind: $.TypeKind.Basic, name: "int8", typeName: "big.Accuracy" } }] }, { name: "UnmarshalText", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: "error" }] }, { name: "fmtB", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "fmtP", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "fmtX", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "ord", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "pow5", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "round", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [] }, { name: "scan", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }, { type: { kind: $.TypeKind.Basic, name: "int" } }, { type: "error" }] }, { name: "setBits64", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "big.Float" } }] }, { name: "setExpAndRound", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [] }, { name: "sqrtInverse", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [] }, { name: "uadd", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [] }, { name: "ucmp", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "umul", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [] }, { name: "uquo", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [] }, { name: "usub", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [] }, { name: "validate", args: [], returns: [] }, { name: "validate0", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "string" } }] }],
		Float,
		[{ name: "prec", key: "prec", type: { kind: $.TypeKind.Basic, name: "uint32" } }, { name: "mode", key: "mode", type: { kind: $.TypeKind.Basic, name: "uint8", typeName: "big.RoundingMode" } }, { name: "acc", key: "acc", type: { kind: $.TypeKind.Basic, name: "int8", typeName: "big.Accuracy" } }, { name: "form", key: "form", type: { kind: $.TypeKind.Basic, name: "uint8", typeName: "big.form" } }, { name: "neg", key: "neg", type: { kind: $.TypeKind.Basic, name: "bool" } }, { name: "mant", key: "mant", type: "big.nat" }, { name: "exp", key: "exp", type: { kind: $.TypeKind.Basic, name: "int32" } }]
	)
}
...
export async function NewFloat(x: number): globalThis.Promise<Float | $.VarRef<Float> | null> {
	if (math.IsNaN(x)) {
		$.panic($.interfaceValue<any>($.markAsStructValue(new ErrNaN({msg: "NewFloat(NaN)"})), "big.ErrNaN"))
	}
