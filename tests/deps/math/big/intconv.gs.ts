...
export class byteReader {
	...
	static __typeInfo = $.registerStructType(
		"big.byteReader",
		() => new byteReader(),
		[{ name: "ReadByte", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "uint8" } }, { type: "error" }] }, { name: "UnreadByte", args: [], returns: [{ type: "error" }] }, { name: "Read", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Basic, name: "int" } }, { type: "error" }] }, { name: "ReadRune", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "int32" } }, { type: { kind: $.TypeKind.Basic, name: "int" } }, { type: "error" }] }, { name: "SkipSpace", args: [], returns: [] }, { name: "Token", args: [{ type: { kind: $.TypeKind.Basic, name: "unknown" } }, { type: { kind: $.TypeKind.Basic, name: "unknown" } }], returns: [{ type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { type: "error" }] }, { name: "UnreadRune", args: [], returns: [{ type: "error" }] }, { name: "Width", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "int" } }, { type: { kind: $.TypeKind.Basic, name: "bool" } }] }],
		byteReader,
		[{ name: "ScanState", key: "ScanState", type: "fmt.ScanState", anonymous: true }]
	)
}
