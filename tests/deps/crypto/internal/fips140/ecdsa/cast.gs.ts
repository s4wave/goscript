...
export async function __goscript_init_fipsSelfTest(): globalThis.Promise<void> {
	...
	await fips140.CAST("ECDSA P-256 SHA2-512 sign and verify", $.functionValue(async (): globalThis.Promise<$.GoError> => {
		...
		{
			let __goscriptShadow0 = await __goscript_ecdsa_noasm.verify({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P256Point" }, zero: () => null }}, await __goscript_ecdsa.P256(), $.pointerValue<__goscript_ecdsa.PrivateKey>(k)._fields.pub, hash, got)
...
export async function __goscript_init_fipsSelfTestDeterministic(): globalThis.Promise<void> {
	...
	await fips140.CAST("DetECDSA P-256 SHA2-512 sign", $.functionValue(async (): globalThis.Promise<$.GoError> => {
		...
		let drbg: __goscript_hmacdrbg.hmacDRBG | $.VarRef<__goscript_hmacdrbg.hmacDRBG> | null = await __goscript_hmacdrbg.newDRBG(undefined, sha512.New, $.pointerValue<__goscript_ecdsa.PrivateKey>(k).d, __goscript_ecdsa.bits2octets({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P256Point" }, zero: () => null }}, await __goscript_ecdsa.P256(), hash), null)
		let __goscriptTuple2: any = await __goscript_ecdsa_noasm.sign({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P256Point" }, zero: () => null }}, await __goscript_ecdsa.P256(), k, drbg, hash)
		...
		{
			let __goscriptShadow1 = await __goscript_ecdsa_noasm.verify({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P256Point" }, zero: () => null }}, await __goscript_ecdsa.P256(), $.pointerValue<__goscript_ecdsa.PrivateKey>(k)._fields.pub, hash, got)
