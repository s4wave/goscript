...
export async function matchesSpecificCurve(params: CurveParams | $.VarRef<CurveParams> | null): globalThis.Promise<[__goscript_elliptic.Curve | null, boolean]> {
	for (let __goscriptRangeTarget1 = $.arrayToSlice<__goscript_elliptic.Curve | null>([$.interfaceValue<__goscript_elliptic.Curve | null>(__goscript_nistec.__goscript_get_p224(), "*elliptic.nistCurve", { kind: $.TypeKind.Pointer, elemType: "elliptic.nistCurve" }), $.interfaceValue<__goscript_elliptic.Curve | null>(__goscript_nistec.__goscript_get_p256(), "*elliptic.nistCurve", { kind: $.TypeKind.Pointer, elemType: "elliptic.nistCurve" }), $.interfaceValue<__goscript_elliptic.Curve | null>(__goscript_nistec.__goscript_get_p384(), "*elliptic.nistCurve", { kind: $.TypeKind.Pointer, elemType: "elliptic.nistCurve" }), $.interfaceValue<__goscript_elliptic.Curve | null>(__goscript_nistec.__goscript_get_p521(), "*elliptic.nistCurve", { kind: $.TypeKind.Pointer, elemType: "elliptic.nistCurve" })]), __rangeIndex = 0; __rangeIndex < $.len(__goscriptRangeTarget1); __rangeIndex++) {
		let c = __goscriptRangeTarget1![__rangeIndex]
		if ($.pointerEqual(params, await $.pointerValue<Exclude<__goscript_elliptic.Curve, null>>(c).Params())) {
			return [c, true]
		}
	}
	return [null, false]
