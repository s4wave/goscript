	...
	public async Bytes(): globalThis.Promise<[$.Slice<number>, $.GoError]> {
		const pub: PublicKey | $.VarRef<PublicKey> | null = this
		{
			...
			switch (true) {
				...
				{
					return publicKeyBytes({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P224Point" }, zero: () => null }}, await ecdsa.P224(), pub)
					break
				}
				case $.comparableEqual(__goscriptSwitch0, await elliptic.P256()):
				{
					return publicKeyBytes({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P256Point" }, zero: () => null }}, await ecdsa.P256(), pub)
					break
				}
				case $.comparableEqual(__goscriptSwitch0, await elliptic.P384()):
				{
					return publicKeyBytes({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P384Point" }, zero: () => null }}, await ecdsa.P384(), pub)
					break
				}
				case $.comparableEqual(__goscriptSwitch0, await elliptic.P521()):
				{
					return publicKeyBytes({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P521Point" }, zero: () => null }}, await ecdsa.P521(), pub)
					break
				}
				default:
				{
	...
	public async Bytes(): globalThis.Promise<[$.Slice<number>, $.GoError]> {
		const priv: PrivateKey | $.VarRef<PrivateKey> | null = this
		{
			...
			switch (true) {
				...
				{
					return privateKeyBytes({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P224Point" }, zero: () => null }}, await ecdsa.P224(), priv)
					break
				}
				case $.comparableEqual(__goscriptSwitch2, await elliptic.P256()):
				{
					return privateKeyBytes({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P256Point" }, zero: () => null }}, await ecdsa.P256(), priv)
					break
				}
				case $.comparableEqual(__goscriptSwitch2, await elliptic.P384()):
				{
					return privateKeyBytes({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P384Point" }, zero: () => null }}, await ecdsa.P384(), priv)
					break
				}
				case $.comparableEqual(__goscriptSwitch2, await elliptic.P521()):
				{
					return privateKeyBytes({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P521Point" }, zero: () => null }}, await ecdsa.P521(), priv)
					break
				}
				default:
				{
...
export async function ParseUncompressedPublicKey(curve: elliptic.Curve | null, data: $.Slice<number>): globalThis.Promise<[PublicKey | $.VarRef<PublicKey> | null, $.GoError]> {
	...
	}
	{
		...
		switch (true) {
			...
			{
				return parseUncompressedPublicKey({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P224Point" }, zero: () => null }}, await ecdsa.P224(), curve, data)
				break
			}
			case $.comparableEqual(__goscriptSwitch1, await elliptic.P256()):
			{
				return parseUncompressedPublicKey({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P256Point" }, zero: () => null }}, await ecdsa.P256(), curve, data)
				break
			}
			case $.comparableEqual(__goscriptSwitch1, await elliptic.P384()):
			{
				return parseUncompressedPublicKey({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P384Point" }, zero: () => null }}, await ecdsa.P384(), curve, data)
				break
			}
			case $.comparableEqual(__goscriptSwitch1, await elliptic.P521()):
			{
				return parseUncompressedPublicKey({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P521Point" }, zero: () => null }}, await ecdsa.P521(), curve, data)
				break
			}
			default:
			{
...
export async function publicKeyBytes(__typeArgs: $.GenericTypeArgs | undefined, c: ecdsa.Curve | $.VarRef<ecdsa.Curve> | null, pub: PublicKey | $.VarRef<PublicKey> | null): globalThis.Promise<[$.Slice<number>, $.GoError]> {
	let __goscriptTuple3: any = await publicKeyToFIPS({P: __typeArgs?.["P"] ?? { type: { kind: $.TypeKind.Interface, methods: [{ name: "Add", args: [{ name: "p1", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "p2", type: { kind: $.TypeKind.Interface, methods: [] } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }] }, { name: "Bytes", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "BytesX", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "ScalarBaseMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "ScalarMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_p1", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "SetBytes", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }] }, zero: () => null }}, c, pub)
...
export async function ParseRawPrivateKey(curve: elliptic.Curve | null, data: $.Slice<number>): globalThis.Promise<[PrivateKey | $.VarRef<PrivateKey> | null, $.GoError]> {
	{
		...
		switch (true) {
			...
			{
				return parseRawPrivateKey({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P224Point" }, zero: () => null }}, await ecdsa.P224(), nistec.NewP224Point, curve, data)
				break
			}
			case $.comparableEqual(__goscriptSwitch4, await elliptic.P256()):
			{
				return parseRawPrivateKey({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P256Point" }, zero: () => null }}, await ecdsa.P256(), nistec.NewP256Point, curve, data)
				break
			}
			case $.comparableEqual(__goscriptSwitch4, await elliptic.P384()):
			{
				return parseRawPrivateKey({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P384Point" }, zero: () => null }}, await ecdsa.P384(), nistec.NewP384Point, curve, data)
				break
			}
			case $.comparableEqual(__goscriptSwitch4, await elliptic.P521()):
			{
				return parseRawPrivateKey({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P521Point" }, zero: () => null }}, await ecdsa.P521(), nistec.NewP521Point, curve, data)
				break
			}
			default:
			{
...
export async function GenerateKey(c: elliptic.Curve | null, r: io.Reader | null): globalThis.Promise<[PrivateKey | $.VarRef<PrivateKey> | null, $.GoError]> {
	...
	switch (await $.pointerValue<Exclude<elliptic.Curve, null>>(c).Params()) {
		...
		{
			return generateFIPS({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P224Point" }, zero: () => null }}, c, await ecdsa.P224(), r)
			break
		}
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P256())).Params():
		{
			return generateFIPS({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P256Point" }, zero: () => null }}, c, await ecdsa.P256(), r)
			break
		}
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P384())).Params():
		{
			return generateFIPS({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P384Point" }, zero: () => null }}, c, await ecdsa.P384(), r)
			break
		}
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P521())).Params():
		{
			return generateFIPS({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P521Point" }, zero: () => null }}, c, await ecdsa.P521(), r)
			break
		}
		default:
		{
...
export async function generateFIPS(__typeArgs: $.GenericTypeArgs | undefined, curve: elliptic.Curve | null, c: ecdsa.Curve | $.VarRef<ecdsa.Curve> | null, rand: io.Reader | null): globalThis.Promise<[PrivateKey | $.VarRef<PrivateKey> | null, $.GoError]> {
	...
	let __goscriptTuple10: any = await ecdsa.GenerateKey({P: __typeArgs?.["P"] ?? { type: { kind: $.TypeKind.Interface, methods: [{ name: "Add", args: [{ name: "p1", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "p2", type: { kind: $.TypeKind.Interface, methods: [] } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }] }, { name: "Bytes", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "BytesX", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "ScalarBaseMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "ScalarMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_p1", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "SetBytes", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }] }, zero: () => null }}, c, rand)
...
export async function SignASN1(r: io.Reader | null, priv: PrivateKey | $.VarRef<PrivateKey> | null, hash: $.Slice<number>): globalThis.Promise<[$.Slice<number>, $.GoError]> {
	...
	switch (await $.pointerValue<Exclude<elliptic.Curve, null>>($.pointerValue<PrivateKey>(priv).PublicKey.Curve).Params()) {
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P224())).Params():
		{
			return signFIPS({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P224Point" }, zero: () => null }}, await ecdsa.P224(), priv, r, hash)
			break
		}
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P256())).Params():
		{
			return signFIPS({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P256Point" }, zero: () => null }}, await ecdsa.P256(), priv, r, hash)
			break
		}
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P384())).Params():
		{
			return signFIPS({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P384Point" }, zero: () => null }}, await ecdsa.P384(), priv, r, hash)
			break
		}
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P521())).Params():
		{
			return signFIPS({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P521Point" }, zero: () => null }}, await ecdsa.P521(), priv, r, hash)
			break
		}
		default:
		{
...
export async function signFIPS(__typeArgs: $.GenericTypeArgs | undefined, c: ecdsa.Curve | $.VarRef<ecdsa.Curve> | null, priv: PrivateKey | $.VarRef<PrivateKey> | null, rand: io.Reader | null, hash: $.Slice<number>): globalThis.Promise<[$.Slice<number>, $.GoError]> {
	...
	let __goscriptTuple12: any = await privateKeyToFIPS({P: __typeArgs?.["P"] ?? { type: { kind: $.TypeKind.Interface, methods: [{ name: "Add", args: [{ name: "p1", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "p2", type: { kind: $.TypeKind.Interface, methods: [] } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }] }, { name: "Bytes", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "BytesX", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "ScalarBaseMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "ScalarMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_p1", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "SetBytes", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }] }, zero: () => null }}, c, priv)
	...
	let __goscriptTuple13: any = await ecdsa.Sign({P: __typeArgs?.["P"] ?? { type: { kind: $.TypeKind.Interface, methods: [{ name: "Add", args: [{ name: "p1", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "p2", type: { kind: $.TypeKind.Interface, methods: [] } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }] }, { name: "Bytes", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "BytesX", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "ScalarBaseMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "ScalarMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_p1", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "SetBytes", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }] }, zero: () => null }}, c, sha512.New, k, rand, hash)
...
export async function signRFC6979(priv: PrivateKey | $.VarRef<PrivateKey> | null, hash: $.Slice<number>, opts: crypto.SignerOpts | null): globalThis.Promise<[$.Slice<number>, $.GoError]> {
	...
	switch (await $.pointerValue<Exclude<elliptic.Curve, null>>($.pointerValue<PrivateKey>(priv).PublicKey.Curve).Params()) {
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P224())).Params():
		{
			return signFIPSDeterministic({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P224Point" }, zero: () => null }}, await ecdsa.P224(), h, priv, hash)
			break
		}
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P256())).Params():
		{
			return signFIPSDeterministic({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P256Point" }, zero: () => null }}, await ecdsa.P256(), h, priv, hash)
			break
		}
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P384())).Params():
		{
			return signFIPSDeterministic({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P384Point" }, zero: () => null }}, await ecdsa.P384(), h, priv, hash)
			break
		}
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P521())).Params():
		{
			return signFIPSDeterministic({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P521Point" }, zero: () => null }}, await ecdsa.P521(), h, priv, hash)
			break
		}
		default:
		{
...
export async function signFIPSDeterministic(__typeArgs: $.GenericTypeArgs | undefined, c: ecdsa.Curve | $.VarRef<ecdsa.Curve> | null, hashFunc: crypto.Hash, priv: PrivateKey | $.VarRef<PrivateKey> | null, hash: $.Slice<number>): globalThis.Promise<[$.Slice<number>, $.GoError]> {
	let __goscriptTuple14: any = await privateKeyToFIPS({P: __typeArgs?.["P"] ?? { type: { kind: $.TypeKind.Interface, methods: [{ name: "Add", args: [{ name: "p1", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "p2", type: { kind: $.TypeKind.Interface, methods: [] } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }] }, { name: "Bytes", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "BytesX", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "ScalarBaseMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "ScalarMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_p1", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "SetBytes", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }] }, zero: () => null }}, c, priv)
	...
	let __goscriptTuple15: any = await ecdsa.SignDeterministic({P: __typeArgs?.["P"] ?? { type: { kind: $.TypeKind.Interface, methods: [{ name: "Add", args: [{ name: "p1", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "p2", type: { kind: $.TypeKind.Interface, methods: [] } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }] }, { name: "Bytes", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "BytesX", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "ScalarBaseMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "ScalarMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_p1", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "SetBytes", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }] }, zero: () => null }}, c, h, k, hash)
...
export async function VerifyASN1(pub: PublicKey | $.VarRef<PublicKey> | null, hash: $.Slice<number>, sig: $.Slice<number>): globalThis.Promise<boolean> {
	...
	switch (await $.pointerValue<Exclude<elliptic.Curve, null>>($.pointerValue<PublicKey>(pub).Curve).Params()) {
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P224())).Params():
		{
			return verifyFIPS({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P224Point" }, zero: () => null }}, await ecdsa.P224(), pub, hash, sig)
			break
		}
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P256())).Params():
		{
			return verifyFIPS({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P256Point" }, zero: () => null }}, await ecdsa.P256(), pub, hash, sig)
			break
		}
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P384())).Params():
		{
			return verifyFIPS({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P384Point" }, zero: () => null }}, await ecdsa.P384(), pub, hash, sig)
			break
		}
		case await $.pointerValue<Exclude<elliptic.Curve, null>>((await elliptic.P521())).Params():
		{
			return verifyFIPS({P: { type: { kind: $.TypeKind.Pointer, elemType: "nistec.P521Point" }, zero: () => null }}, await ecdsa.P521(), pub, hash, sig)
			break
		}
		default:
		{
...
export async function verifyFIPS(__typeArgs: $.GenericTypeArgs | undefined, c: ecdsa.Curve | $.VarRef<ecdsa.Curve> | null, pub: PublicKey | $.VarRef<PublicKey> | null, hash: $.Slice<number>, sig: $.Slice<number>): globalThis.Promise<boolean> {
	...
	let __goscriptTuple18: any = await publicKeyToFIPS({P: __typeArgs?.["P"] ?? { type: { kind: $.TypeKind.Interface, methods: [{ name: "Add", args: [{ name: "p1", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "p2", type: { kind: $.TypeKind.Interface, methods: [] } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }] }, { name: "Bytes", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "BytesX", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "ScalarBaseMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "ScalarMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_p1", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "SetBytes", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }] }, zero: () => null }}, c, pub)
...
export async function publicKeyToFIPS(__typeArgs: $.GenericTypeArgs | undefined, c: ecdsa.Curve | $.VarRef<ecdsa.Curve> | null, pub: PublicKey | $.VarRef<PublicKey> | null): globalThis.Promise<[ecdsa.PublicKey | $.VarRef<ecdsa.PublicKey> | null, $.GoError]> {
	...
	return ecdsa.NewPublicKey({P: __typeArgs?.["P"] ?? { type: { kind: $.TypeKind.Interface, methods: [{ name: "Add", args: [{ name: "p1", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "p2", type: { kind: $.TypeKind.Interface, methods: [] } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }] }, { name: "Bytes", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "BytesX", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "ScalarBaseMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "ScalarMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_p1", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "SetBytes", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }] }, zero: () => null }}, c, Q)
}
...
export async function privateKeyToFIPS(__typeArgs: $.GenericTypeArgs | undefined, c: ecdsa.Curve | $.VarRef<ecdsa.Curve> | null, priv: PrivateKey | $.VarRef<PrivateKey> | null): globalThis.Promise<[ecdsa.PrivateKey | $.VarRef<ecdsa.PrivateKey> | null, $.GoError]> {
	...
	const __goscriptReturn43 = await privateKeyCache.value.Get({K: { type: "ecdsa.PrivateKey", zero: () => $.markAsStructValue(new PrivateKey()), methods: {Add: (receiver: any, ...args: any[]) => receiver.Add(...args), Double: (receiver: any, ...args: any[]) => receiver.Double(...args), IsOnCurve: (receiver: any, ...args: any[]) => receiver.IsOnCurve(...args), Params: (receiver: any, ...args: any[]) => receiver.Params(...args), ScalarBaseMult: (receiver: any, ...args: any[]) => receiver.ScalarBaseMult(...args), ScalarMult: (receiver: any, ...args: any[]) => receiver.ScalarMult(...args)} }, V: { type: "ecdsa.PrivateKey", zero: () => $.markAsStructValue(new ecdsa.PrivateKey()) }}, priv, $.functionValue(async (): globalThis.Promise<[ecdsa.PrivateKey | $.VarRef<ecdsa.PrivateKey> | null, $.GoError]> => {
		return await ecdsa.NewPrivateKey({P: __typeArgs?.["P"] ?? { type: { kind: $.TypeKind.Interface, methods: [{ name: "Add", args: [{ name: "p1", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "p2", type: { kind: $.TypeKind.Interface, methods: [] } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }] }, { name: "Bytes", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "BytesX", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "ScalarBaseMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "ScalarMult", args: [{ name: "_p0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_p1", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }, { name: "SetBytes", args: [{ name: "_p0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "_r1", type: "error" }] }] }, zero: () => null }}, c, D, Q)
