...
export class dnsConstraints {
	...
	public async query(s: string): globalThis.Promise<[string, boolean]> {
		...
		let __goscriptTuple0: any = await nameConstraintsSet.prototype.search.call($.pointerValue<dnsConstraints>(dnc).constraints, {T: { type: { kind: $.TypeKind.Basic, name: "string" }, zero: () => "" }, V: { type: { kind: $.TypeKind.Basic, name: "string" }, zero: () => "" }}, s, dnsCompare, dnsHasSuffix)
...
export async function newDNSConstraints(l: $.Slice<string>, permitted: boolean): globalThis.Promise<any> {
	...
	await nameConstraintsSet.prototype.sortAndPrune.call($.pointerValue<dnsConstraints>(nc).constraints, {T: { type: { kind: $.TypeKind.Basic, name: "string" }, zero: () => "" }, V: { type: { kind: $.TypeKind.Basic, name: "string" }, zero: () => "" }}, dnsCompare, dnsHasSuffix)
