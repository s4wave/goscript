// Generated file based on udpsock_posix.go
...
import * as __goscript_sockoptip_stub from "./sockoptip_stub.gs.ts"
...
import "./sockoptip_stub.gs.ts"
import "./tcpsock.gs.ts"
import "./udpsock.gs.ts"

export async function sockaddrToUDP(sa: syscall.Sockaddr | null): globalThis.Promise<__goscript_net.Addr | null> {
	{
			...
			case $.typeAssert<syscall.SockaddrInet4 | $.VarRef<syscall.SockaddrInet4> | null>(__goscriptTypeSwitchValue, { kind: $.TypeKind.Pointer, elemType: "syscall.SockaddrInet4" }).ok:
				{
					...
					return $.interfaceValue<__goscript_net.Addr | null>(new __goscript_udpsock.UDPAddr({IP: ($.goSlice($.pointerValue<syscall.SockaddrInet4>(sa).Addr, 0, undefined) as __goscript_ip.IP), Port: $.pointerValue<syscall.SockaddrInet4>(sa).Port}), "*net.UDPAddr", { kind: $.TypeKind.Pointer, elemType: "net.UDPAddr" })
				}
				break
			case $.typeAssert<syscall.SockaddrInet6 | $.VarRef<syscall.SockaddrInet6> | null>(__goscriptTypeSwitchValue, { kind: $.TypeKind.Pointer, elemType: "syscall.SockaddrInet6" }).ok:
				{
					...
					return $.interfaceValue<__goscript_net.Addr | null>((await (async () => { const __goscriptLiteralField0 = await $.pointerValue<__goscript__interface.ipv6ZoneCache>(__goscript__interface.zoneCache).name($.int($.pointerValue<syscall.SockaddrInet6>(sa).ZoneId)); return new __goscript_udpsock.UDPAddr({IP: ($.goSlice($.pointerValue<syscall.SockaddrInet6>(sa).Addr, 0, undefined) as __goscript_ip.IP), Port: $.pointerValue<syscall.SockaddrInet6>(sa).Port, Zone: __goscriptLiteralField0}) })()), "*net.UDPAddr", { kind: $.TypeKind.Pointer, elemType: "net.UDPAddr" })
				}
				break
		}
	}
...
export function listenIPv4MulticastUDP(c: __goscript_udpsock.UDPConn | $.VarRef<__goscript_udpsock.UDPConn> | null, ifi: __goscript__interface.Interface | $.VarRef<__goscript__interface.Interface> | null, ip: __goscript_ip.IP): $.GoError {
	if (ifi != null) {
		{
			let err = __goscript_sockoptip_stub.setIPv4MulticastInterface($.pointerValue<__goscript_udpsock.UDPConn>(c).conn.fd, ifi)
			if (err != null) {
				return err
			}
		}
	...
	{
		let err = __goscript_sockoptip_stub.setIPv4MulticastLoopback($.pointerValue<__goscript_udpsock.UDPConn>(c).conn.fd, false)
		if (err != null) {
			return err
		}
	}
	{
		let err = __goscript_sockoptip_stub.joinIPv4Group($.pointerValue<__goscript_udpsock.UDPConn>(c).conn.fd, ifi, (ip as __goscript_ip.IP))
		if (err != null) {
			return err
		}
	}
...
export function listenIPv6MulticastUDP(c: __goscript_udpsock.UDPConn | $.VarRef<__goscript_udpsock.UDPConn> | null, ifi: __goscript__interface.Interface | $.VarRef<__goscript__interface.Interface> | null, ip: __goscript_ip.IP): $.GoError {
	if (ifi != null) {
		{
			let err = __goscript_sockoptip_stub.setIPv6MulticastInterface($.pointerValue<__goscript_udpsock.UDPConn>(c).conn.fd, ifi)
			if (err != null) {
				return err
			}
		}
	...
	{
		let err = __goscript_sockoptip_stub.setIPv6MulticastLoopback($.pointerValue<__goscript_udpsock.UDPConn>(c).conn.fd, false)
		if (err != null) {
			return err
		}
	}
	{
		let err = __goscript_sockoptip_stub.joinIPv6Group($.pointerValue<__goscript_udpsock.UDPConn>(c).conn.fd, ifi, (ip as __goscript_ip.IP))
		if (err != null) {
			return err
		}
	}
