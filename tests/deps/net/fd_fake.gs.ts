...
export function newPollFD(net: string, pfd: poll.FD): netFD | $.VarRef<netFD> | null {
	...
	switch (net) {
		case "tcp":
		{
			laddr = $.interfaceValue<__goscript_net.Addr | null>(new __goscript_tcpsock.TCPAddr(), "*net.TCPAddr", { kind: $.TypeKind.Pointer, elemType: "net.TCPAddr" })
			raddr = $.interfaceValue<__goscript_net.Addr | null>(new __goscript_tcpsock.TCPAddr(), "*net.TCPAddr", { kind: $.TypeKind.Pointer, elemType: "net.TCPAddr" })
			break
		}
		case "udp":
		{
			laddr = $.interfaceValue<__goscript_net.Addr | null>(new __goscript_udpsock.UDPAddr(), "*net.UDPAddr", { kind: $.TypeKind.Pointer, elemType: "net.UDPAddr" })
			raddr = $.interfaceValue<__goscript_net.Addr | null>(new __goscript_udpsock.UDPAddr(), "*net.UDPAddr", { kind: $.TypeKind.Pointer, elemType: "net.UDPAddr" })
			break
		}
		default:
		{
			laddr = $.interfaceValue<__goscript_net.Addr | null>($.markAsStructValue(new unknownAddr()), "net.unknownAddr", "net.unknownAddr")
			raddr = $.interfaceValue<__goscript_net.Addr | null>($.markAsStructValue(new unknownAddr()), "net.unknownAddr", "net.unknownAddr")
			break
		}
	}
