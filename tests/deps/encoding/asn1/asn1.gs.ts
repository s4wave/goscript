...
export let bitStringType: reflect.Type | null = reflect.TypeFor({[$.genericTypeArgsMarker]: true, T: { type: "asn1.BitString", zero: () => $.markAsStructValue(new BitString()), methods: {At: (receiver: any, ...args: any[]) => receiver.At(...$.stripGenericTypeArgs(args)), RightAlign: (receiver: any, ...args: any[]) => receiver.RightAlign(...$.stripGenericTypeArgs(args))} }})

export function __goscript_set_bitStringType(__goscriptValue: reflect.Type | null): void {
	bitStringType = __goscriptValue
}

export let objectIdentifierType: reflect.Type | null = reflect.TypeFor({[$.genericTypeArgsMarker]: true, T: { type: { kind: $.TypeKind.Slice, typeName: "asn1.ObjectIdentifier", elemType: { kind: $.TypeKind.Basic, name: "int" } }, zero: () => null, methods: {Equal: (receiver: any, ...args: any[]) => (ObjectIdentifier_Equal as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args)), String: (receiver: any, ...args: any[]) => (ObjectIdentifier_String as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args))}, methodSignatures: [{ name: "Equal", args: [{ name: "other", type: { kind: $.TypeKind.Slice, typeName: "asn1.ObjectIdentifier", elemType: { kind: $.TypeKind.Basic, name: "int" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "String", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "string" } }] }] }})
