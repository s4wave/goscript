...
export async function byLiteral_sort(s: $.VarRef<byLiteral> | null, a: $.Slice<literalNode>): globalThis.Promise<void> {
	...
	await sort2.Sort($.pointerValueOrNil($.namedValueInterfaceValue<sort2.Interface | null>(s, "*flate.byLiteral", {Len: (receiver: any, ...args: any[]) => (byLiteral_Len as any)($.pointerValue(receiver), ...$.stripGenericTypeArgs(args)), Less: (receiver: any, ...args: any[]) => (byLiteral_Less as any)($.pointerValue(receiver), ...$.stripGenericTypeArgs(args)), Swap: (receiver: any, ...args: any[]) => (byLiteral_Swap as any)($.pointerValue(receiver), ...$.stripGenericTypeArgs(args)), sort: (receiver: any, ...args: any[]) => (byLiteral_sort as any)(receiver, ...$.stripGenericTypeArgs(args))}, { kind: $.TypeKind.Pointer, elemType: { kind: $.TypeKind.Slice, typeName: "flate.byLiteral", elemType: "flate.literalNode" } }, [{ name: "Len", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "Less", args: [{ name: "i", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "j", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "Swap", args: [{ name: "i", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "j", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [] }, { name: "sort", args: [{ name: "a", type: { kind: $.TypeKind.Slice, elemType: "flate.literalNode" } }], returns: [] }]))!)
}
