...
export class Element {
	...
	static __typeInfo = $.registerStructType(
		"list.Element",
		() => new Element(),
		[{ name: "Next", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }] }, { name: "Prev", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }] }],
		Element,
		[{ name: "next", key: "next", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" }, pkgPath: "container/list", index: [0], offset: 0, exported: false }, { name: "prev", key: "prev", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" }, pkgPath: "container/list", index: [1], offset: 8, exported: false }, { name: "list", key: "list", type: { kind: $.TypeKind.Pointer, elemType: "list.List" }, pkgPath: "container/list", index: [2], offset: 16, exported: false }, { name: "Value", key: "Value", type: { kind: $.TypeKind.Interface, methods: [] }, index: [3], offset: 24, exported: true }]
	)
}
...
export class List {
	...
	static __typeInfo = $.registerStructType(
		"list.List",
		() => new List(),
		[{ name: "Back", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }] }, { name: "Front", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }] }, { name: "Init", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "list.List" } }] }, { name: "InsertAfter", args: [{ name: "v", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "mark", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }] }, { name: "InsertBefore", args: [{ name: "v", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "mark", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }] }, { name: "Len", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "MoveAfter", args: [{ name: "e", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }, { name: "mark", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }], returns: [] }, { name: "MoveBefore", args: [{ name: "e", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }, { name: "mark", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }], returns: [] }, { name: "MoveToBack", args: [{ name: "e", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }], returns: [] }, { name: "MoveToFront", args: [{ name: "e", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }], returns: [] }, { name: "PushBack", args: [{ name: "v", type: { kind: $.TypeKind.Interface, methods: [] } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }] }, { name: "PushBackList", args: [{ name: "other", type: { kind: $.TypeKind.Pointer, elemType: "list.List" } }], returns: [] }, { name: "PushFront", args: [{ name: "v", type: { kind: $.TypeKind.Interface, methods: [] } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }] }, { name: "PushFrontList", args: [{ name: "other", type: { kind: $.TypeKind.Pointer, elemType: "list.List" } }], returns: [] }, { name: "Remove", args: [{ name: "e", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Interface, methods: [] } }] }, { name: "insert", args: [{ name: "e", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }, { name: "at", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }] }, { name: "insertValue", args: [{ name: "v", type: { kind: $.TypeKind.Interface, methods: [] } }, { name: "at", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }] }, { name: "lazyInit", args: [], returns: [] }, { name: "move", args: [{ name: "e", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }, { name: "at", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }], returns: [] }, { name: "remove", args: [{ name: "e", type: { kind: $.TypeKind.Pointer, elemType: "list.Element" } }], returns: [] }],
		List,
		[{ name: "root", key: "root", type: "list.Element", pkgPath: "container/list", index: [0], offset: 0, exported: false }, { name: "len", key: "len", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "container/list", index: [1], offset: 40, exported: false }]
	)
}
