...
export class PushablePacketWriter {
	...
	public WritePacket(pkt: __goscript_rpcproto_pb.Packet | $.VarRef<__goscript_rpcproto_pb.Packet> | null): $.GoError {
		...
		$.markAsStructValue($.cloneStructValue($.pointerValue<PushablePacketWriter>(w).pushable)).Call("push", $.interfaceValue($.markAsStructValue($.cloneStructValue(a)), "js.Value", "js.Value"))
		return null
	}
