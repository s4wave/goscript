...
export async function main(): globalThis.Promise<void> {
	let utc = $.markAsStructValue($.cloneStructValue(time.Date(2025, 5, 15, 1, 10, 42, 0, time.UTC)))
	let pdt: time.Location | $.VarRef<time.Location> | null = time.FixedZone("PDT", -25200)
