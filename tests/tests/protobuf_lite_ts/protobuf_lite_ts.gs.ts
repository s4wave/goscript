...
export async function main(): globalThis.Promise<void> {
	...
	await $.println("oneof clone independent:", $.uint($.arrayIndex(__goscript_protobuf_lite_ts_pb_ts.ExampleMsg.prototype.GetChoiceData.call(oneofClone)!, 0), 8) == $.uint(1, 8))
