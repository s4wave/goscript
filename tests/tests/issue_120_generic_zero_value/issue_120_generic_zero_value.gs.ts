...
export async function main(): globalThis.Promise<void> {
	...
	let zeroPair = ($.cloneArrayValue(ZeroArrayLiteral({[$.genericTypeArgsMarker]: $.genericTypeArgsBrand, T: { type: "main.Pair", zero: () => $.arrayValue(Array.from({ length: 2 }, () => 0)) }}), "main.Pair") as Pair)
