...
export async function main(): globalThis.Promise<void> {
	await check($.namedValueInterfaceValue<any>($.arrayToSlice<number>([1, 2]), "main.namedSlice", {Add: (receiver: any, ...args: any[]) => (namedSlice_Add as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args))}, { kind: $.TypeKind.Slice, typeName: "main.namedSlice", elemType: { kind: $.TypeKind.Basic, name: "int" } }, [{ name: "Add", args: [{ name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }]))
	await check($.namedValueInterfaceValue<any>($.makeMap<string, number>([["one", 1], ["two", 2]]), "main.namedMap", {Add: (receiver: any, ...args: any[]) => (namedMap_Add as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args))}, "main.namedMap", [{ name: "Add", args: [{ name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }]))
	await check($.namedValueInterfaceValue<any>([1, 2], "main.namedArray", {Add: (receiver: any, ...args: any[]) => (namedArray_Add as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args))}, "main.namedArray", [{ name: "Add", args: [{ name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }]))
	await check($.namedValueInterfaceValue<any>(4, "main.namedInt", {Add: (receiver: any, ...args: any[]) => (namedInt_Add as any)(($.isVarRef(receiver) ? receiver.value : receiver), ...$.stripGenericTypeArgs(args))}, { kind: $.TypeKind.Basic, name: "int", typeName: "main.namedInt" }, [{ name: "Add", args: [{ name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }]))
