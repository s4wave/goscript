...
// source: protobuf_string_sync.proto
...
type ExampleMsg struct {
	unknownFields []byte
	ExampleText   string `protobuf:"bytes,1,opt,name=example_text,json=exampleText,proto3" json:"exampleText,omitempty"`
}
...
func (m *ExampleMsg) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.ExampleText)
