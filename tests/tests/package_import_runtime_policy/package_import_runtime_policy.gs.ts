...
export async function main(): globalThis.Promise<void> {
	...
	await $.println("pprof:", pprof.StartCPUProfile($.pointerValueOrNil($.interfaceValue<io.Writer | null>(profile, "*bytes.Buffer", /* @__PURE__ */ $.pointerType("bytes.Buffer")))!) != null, pprof.Profile.prototype.WriteTo.call($.pointerValue<pprof.Profile>(pprof.Lookup("heap")), $.pointerValueOrNil($.interfaceValue<io.Writer | null>(profile, "*bytes.Buffer", /* @__PURE__ */ $.pointerType("bytes.Buffer")))!, 0) != null)
	...
	await $.println("trace:", trace.Start($.pointerValueOrNil($.interfaceValue<io.Writer | null>(traceBuf, "*bytes.Buffer", /* @__PURE__ */ $.pointerType("bytes.Buffer")))!) != null, trace.IsEnabled())
