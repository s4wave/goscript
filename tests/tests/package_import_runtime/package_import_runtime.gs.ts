...
export async function main(): globalThis.Promise<void> {
	...
	runtime.SetFinalizer($.interfaceValue(box, "*struct{value int}", { kind: $.TypeKind.Pointer, elemType: { kind: $.TypeKind.Struct, methods: [], fields: [{ name: "value", key: "value", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "github.com/s4wave/goscript/tests/tests/package_import_runtime", index: [0], offset: 0, exported: false }] } }), $.interfaceValue($.functionValue((_p0: $.VarRef<{"value": number}> | null): void => {
