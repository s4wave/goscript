...
export async function main(): globalThis.Promise<void> {
	...
	runtime.KeepAlive($.interfaceValue(box, "*struct{value int}", { kind: $.TypeKind.Pointer, elemType: { kind: $.TypeKind.Struct, methods: [], fields: [{ name: "value", key: "value", type: /* @__PURE__ */ $.basicType("int"), pkgPath: "github.com/s4wave/goscript/tests/tests/package_import_runtime", index: [0], offset: 0, exported: false }] } }))
	await $.println("Cleanup stopped")

	runtime.SetFinalizer($.interfaceValue(box, "*struct{value int}", { kind: $.TypeKind.Pointer, elemType: { kind: $.TypeKind.Struct, methods: [], fields: [{ name: "value", key: "value", type: /* @__PURE__ */ $.basicType("int"), pkgPath: "github.com/s4wave/goscript/tests/tests/package_import_runtime", index: [0], offset: 0, exported: false }] } }), $.interfaceValue($.functionValue(async (_p0: $.VarRef<{"value": number}> | null): globalThis.Promise<void> => {
		await $.println("finalizer should not run during test")
	}, ({ kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Pointer, elemType: { kind: $.TypeKind.Struct, methods: [], fields: [{ name: "value", key: "value", type: /* @__PURE__ */ $.basicType("int"), pkgPath: "github.com/s4wave/goscript/tests/tests/package_import_runtime", index: [0], offset: 0, exported: false }] } }], results: [] } as $.FunctionTypeInfo)), "func(*struct{value int})", ({ kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Pointer, elemType: { kind: $.TypeKind.Struct, methods: [], fields: [{ name: "value", key: "value", type: /* @__PURE__ */ $.basicType("int"), pkgPath: "github.com/s4wave/goscript/tests/tests/package_import_runtime", index: [0], offset: 0, exported: false }] } }], results: [] } as $.FunctionTypeInfo)))
	runtime.SetFinalizer($.interfaceValue(box, "*struct{value int}", { kind: $.TypeKind.Pointer, elemType: { kind: $.TypeKind.Struct, methods: [], fields: [{ name: "value", key: "value", type: /* @__PURE__ */ $.basicType("int"), pkgPath: "github.com/s4wave/goscript/tests/tests/package_import_runtime", index: [0], offset: 0, exported: false }] } }), null)
