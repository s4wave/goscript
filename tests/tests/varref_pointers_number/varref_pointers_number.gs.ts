...
export async function main(): globalThis.Promise<void> {
	...
	await $.println("p1==p2:", $.pointerEqual(p1.value, p2))
	await $.println("*p1==*p2:", $.pointerValue<number>(p1.value) == $.pointerValue<number>(p2))
	await $.println("pp1 deref:", $.pointerValue<number>($.pointerValue<$.VarRef<number> | null>(pp1)))
}
