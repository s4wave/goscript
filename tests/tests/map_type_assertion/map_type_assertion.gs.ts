...
export async function main(): globalThis.Promise<void> {
	...
	i = $.interfaceValue($.makeMap<string, number>([["age", 30]]), "map[string]int", { kind: $.TypeKind.Map, keyType: { kind: $.TypeKind.Basic, name: "string" }, elemType: { kind: $.TypeKind.Basic, name: "int" } })
