...
export async function main(): globalThis.Promise<void> {
	...
	let r: rand.ChaCha8 | $.VarRef<rand.ChaCha8> | null = rand.NewChaCha8($.cloneArrayValue(seed, { kind: $.TypeKind.Array, elemType: /* @__PURE__ */ $.basicType("uint8"), length: 32 }))
	for (let i = 0; i < 8; i++) {
	...
	let r2: rand.ChaCha8 | $.VarRef<rand.ChaCha8> | null = rand.NewChaCha8($.cloneArrayValue(seed, { kind: $.TypeKind.Array, elemType: /* @__PURE__ */ $.basicType("uint8"), length: 32 }))
	{
	...
	let seed2 = $.cloneArrayValue(seed, { kind: $.TypeKind.Array, elemType: /* @__PURE__ */ $.basicType("uint8"), length: 32 })
	seed2[0] = $.uint(0xff, 8)
	rand.ChaCha8.prototype.Seed.call(r, $.cloneArrayValue(seed2, { kind: $.TypeKind.Array, elemType: /* @__PURE__ */ $.basicType("uint8"), length: 32 }))
	await $.println(rand.ChaCha8.prototype.Uint64.call(r))
}
