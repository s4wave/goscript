...
export async function main(): globalThis.Promise<void> {
	...
	modifyGenericSlice({[$.genericTypeArgsMarker]: $.genericTypeArgsBrand, S: { type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } }, zero: () => null }, E: { type: { kind: $.TypeKind.Basic, name: "int" }, zero: () => 0 }}, slice, 1, 42)
