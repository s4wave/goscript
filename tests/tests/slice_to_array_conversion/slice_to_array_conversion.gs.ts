...
export async function main(): globalThis.Promise<void> {
	...
	let array = $.cloneArrayValue(($.sliceToArray<number>($.goSlice(values, 1, undefined), 2, "byte") as Uint8Array), { kind: $.TypeKind.Array, elemType: { kind: $.TypeKind.Basic, name: "uint8" }, length: 2 })
	...
	wordPointer!.value = $.cloneArrayValue(replacement, { kind: $.TypeKind.Array, elemType: { kind: $.TypeKind.Basic, name: "uint16" }, length: 2 })
