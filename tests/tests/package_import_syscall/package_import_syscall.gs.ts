...
export async function main(): globalThis.Promise<void> {
	...
	let addr4 = $.markAsStructValue($.cloneStructValue(netip.AddrFrom4($.cloneArrayValue(sa4.Addr, /* @__PURE__ */ $.arrayType(/* @__PURE__ */ $.basicType("uint8"), 4)))))
	sa4.Addr = $.cloneArrayValue($.markAsStructValue($.cloneStructValue(addr4)).As4(), /* @__PURE__ */ $.arrayType(/* @__PURE__ */ $.basicType("uint8"), 4))

	let sa6: syscall.SockaddrInet6 = $.markAsStructValue(new syscall.SockaddrInet6())
	let addr6 = $.markAsStructValue($.cloneStructValue(netip.AddrFrom16($.cloneArrayValue(sa6.Addr, /* @__PURE__ */ $.arrayType(/* @__PURE__ */ $.basicType("uint8"), 16)))))
	sa6.Addr = $.cloneArrayValue($.markAsStructValue($.cloneStructValue(addr6)).As16(), /* @__PURE__ */ $.arrayType(/* @__PURE__ */ $.basicType("uint8"), 16))
